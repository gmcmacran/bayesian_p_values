...
ggsave(filename = "results/graphs/gaussian_mu_less.png", width = 10, height = 10)
...
ggsave(filename = "results/graphs/gaussian_mu_greater.png", width = 10, height = 10)
...
ggsave(filename = "results/graphs/gaussian_mu_prior_params.png", width = 10, height = 10)
...
ggsave(filename = "results/graphs/gaussian_mu_prior_params_two.png", width = 10, height = 10)
